...
#ifndef CALENDARITEMREPOSITORY_H
#define CALENDARITEMREPOSITORY_H
...
{
public:
    using ReadResult = ::ReadResult<CalendarItem>;

    explicit CalendarItemRepository(const StorageCollectionRef &collection, const VdirIo &vdirIo);
...
private:
    ...
    StorageResult<CalendarItem> createCalendar(const QString &href, CalendarItem object) const;
    StorageResult<CalendarItem>
    replaceCalendar(const QString &href, CalendarItem object, const QString &expectedEtag) const;
    VdirItemRepository m_items;
};

#endif // CALENDARITEMREPOSITORY_H
